...
public struct ChartMeta: Decodable {
    ...
    enum CurrentTrandingKeys: CodingKey {
        case pre
        case regular
        case post
    }
    
    enum TrandingPeriodKeys: CodingKey {
        case start
        case end
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        let currentTradingPeriodContainer = try?container.nestedContainer(keyedBy: CurrentTrandingKeys.self, forKey: .currentTradingPeriod)
        let regularTradingPeriodContainer = try?currentTradingPeriodContainer?.nestedContainer(keyedBy: TrandingPeriodKeys.self, forKey: .regular)
